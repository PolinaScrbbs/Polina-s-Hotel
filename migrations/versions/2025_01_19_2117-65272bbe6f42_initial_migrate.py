...
def upgrade() -> None:
    ...
    op.create_table('equirement_elements',
    ...
    sa.Column('category', sa.Enum('SINGLE_STANDARD', 'SINGLE_ROOM_ECONOMY', 'STANDARD_DOUBLE_ROOM_WITH_TWO_SEPARATE_BEDS', 'ROOM_ECONOMY_DOUBLE_ROOM_WITH_TWO_SEPARATE_BEDS', 'TRIPLE_BUDGET', 'ONE_BED_BUSINESS', 'BUSINESS_WITH_TWO_BEDS', 'TWO_ROOM_STANDARD_DOUBLE_ROOM_WITH_ONE_BED', 'TWO_ROOM_DOUBLE_STANDARD_WITH_TWO_BEDS', 'ATELIER', 'A_SUITE_WITH_A_DOUBLE_BED', name='roomcategory'), nullable=False),
    sa.Column('floor', sa.Integer(), nullable=False),
    sa.Column('status', sa.Enum('FREE', 'BUSY', 'CLEANING', name='roomstatus'), nullable=False),
    ...
    sa.Column('role', sa.Enum('USER', 'CLIENT', 'ADMIN', name='role'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['room'], ['hotel_rooms.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('room_equirement_elements',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('room_id', sa.Integer(), nullable=False),
    sa.Column('element_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['element_id'], ['equirement_elements.id'], ),
